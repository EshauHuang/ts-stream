...
export const PlayStartIcon = styled(PlayStartSvg)``;

export const VolumeHighIcon = styled(VolumeHighSvg)``;

export const VolumeLowIcon = styled(VolumeLowSvg)``;

export const VolumeMutedIcon = styled(VolumeMutedSvg)``;

export const FullScreenCloseIcon = styled(FullScreenCloseSvg)``;

export const FullScreenOpenIcon = styled(FullScreenOpenSvg)``;

export const MiniPlayerIcon = styled(MiniPlayerSvg)``;

export const TheaterTallIcon = styled(TheaterTallSvg)``;
